...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Óculos de sol e armações premium, com pagamento na entrega em Moçambique." },
      { name: "author", content: "SOLIS" },
      { property: "og:title", content: "SOLIS — Óculos premium em Moçambique" },
      { property: "og:description", content: "Óculos de sol e armações premium, com pagamento na entrega em Moçambique." },
